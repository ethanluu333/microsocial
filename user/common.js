...
function log_event(eventBody) {
  axios.post(uri(ANALYTICS_SERVICE_NAME,'/events'), eventBody)
  // Event logging is "fire and forget" so we don't wait or worry about errors.
  //  .catch(function (error) {
  //   console.log({message:`failed logging ${eventBody.type}`, error});
  // });
}
...
function returnError(res, event) {
  ...
  statusMessage = ('statusMessage' in event)? event.statusMessage : getReasonPhrase(statusCode)
